...
public record VehicleDto(Guid Id, string CarNumber);

public record CustomerDto(Guid Id, string Name, string Phone, List<VehicleDto> Vehicles);
...
public record IntakeRequest(string Name, string Phone, string CarNumber);
