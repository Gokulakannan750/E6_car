...
public record InvoiceDto(
    ...
    Guid VehicleId, string CarNumber,
...
/// <summary>Steps 1-3: create the quotation (customer, car, chosen services).</summary>
public record CreateQuotationRequest(
    string CustomerName, string CustomerPhone, string CarNumber,
    decimal DiscountAmount, string? Notes, List<InvoiceItemInput> Items);

/// <summary>Step 4: edit a quotation/invoice — add jobs done, change discount/notes.</summary>
public record UpdateInvoiceRequest(decimal DiscountAmount, string? Notes, List<InvoiceItemInput> Items);
...
public record InvoiceListItemDto(
    ...
    string CustomerName, string CarNumber, decimal GrandTotal, decimal Balance, DateTime CreatedAt);
